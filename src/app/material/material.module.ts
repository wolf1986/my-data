...
import { MatDatepickerModule, MatAutocompleteModule, MatTableModule } from '@angular/material';
...
const modules = [
  ...
  MatMenuModule, MatListModule, MatDatepickerModule, MatMomentDateModule, MatAutocompleteModule, MatTableModule
];
