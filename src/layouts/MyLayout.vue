    ...
    <q-layout view="lHh Lpr lFf">
          ...
          <q-btn round dense flat icon="notifications">
            ...
            <q-tooltip anchor="center left" self="center middle">Notifications</q-tooltip>
                    ...
                    <q-btn
                        round
                        color="blue-grey-5"
                        v-if="!isAuthFinished || !isSignedIn"
                        size="13px"
                    >
        ...
        <q-drawer v-model="leftDrawerOpen" bordered content-class="bg-grey-2">
            <q-list>
                ...
                <!-- Route - Home -->
                <q-item clickable tag="a" @click="$router.replace({path: '/'})">
                    <q-item-section avatar>
                ...
                <!-- Route - Demo Form -->
                <q-item clickable tag="a" @click="$router.replace({path: '/demo-form'})">
                    <q-item-section avatar>
                        <q-icon name="fas fa-glass-cheers" />
                    </q-item-section>
                    <q-item-section>
                        <q-item-label>Demo Form</q-item-label>
                    </q-item-section>
                </q-item>
...
export default Vue.extend({
    ...
    created() {
        ...
        GoogleAuthHelper.discoveryDocs = Config.Google.DiscoveryDocs;
